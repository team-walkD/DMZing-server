insert into course(type,  main_description, sub_description, image_url, line_image_url,background_image_url, level, estimated_time, price) values (0, '첫번째 이거슨 데이트 코스', '데이트 코스 서브 설명', 'https://dmzing-s3.s3.ap-northeast-2.amazonaws.com/review/1542385562535_review_date_img%402x.png', 'www.image.example.com1','www.image.example.com1', 0, 3, 0);
insert into course(type,  main_description, sub_description, image_url, line_image_url,background_image_url, level, estimated_time, price) values (1, '첫번째 이거슨 역사기행 코스', '역사기행 코스 서브 설명', 'https://dmzing-s3.s3.ap-northeast-2.amazonaws.com/review/1542385611095_review_explore_img%402x.png', 'www.image.example.com1','www.image.example.com1', 1, 4, 400);
insert into course(type,  main_description, sub_description, image_url, line_image_url,background_image_url,level, estimated_time, price) values (2, '첫번째 이거슨 탐험 코스', '탐험 코스 서브 설명', 'https://dmzing-s3.s3.ap-northeast-2.amazonaws.com/review/1542385642186_review_history_img%402x.png', 'www.image.example.com1','www.image.example.com1', 2, 3.5, 550);
