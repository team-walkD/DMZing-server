 insert into course(type,  main_description, sub_description, image_url, line_image_url, level, estimated_time, price) values (0, '첫번째 이거슨 데이트 코스', '데이트 코스 서브 설명', 'www.image.example.com1', 'www.image.example.com1', 0, 3, 0);
